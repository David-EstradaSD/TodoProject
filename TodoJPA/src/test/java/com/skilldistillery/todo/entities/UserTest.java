...
class UserTest {
	...
	@Test
	@DisplayName("testing User to Todo mapping")
	void test2() {
		assertNotNull(user);
		assertTrue(!user.getTodos().isEmpty()); // testing if the User 1 ("shaun") DOES NOT have empty list of todos
		// aka he DOES have todos.
	}
